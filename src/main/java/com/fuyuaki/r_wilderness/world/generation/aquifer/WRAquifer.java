...
import com.fuyuaki.r_wilderness.world.generation.noise.Cellular3D;
...
public class WRAquifer implements Aquifer {
    ...
    public WRAquifer(ChunkPos chunkPos, ChunkNoiseSamplingSettings settings, int seaLevel, PositionalRandomFactory fork, NormalNoise barrierNoise)
...
//                }
    ...
    private AquiferEntry createAquifer(int x, int y, int z)
    {
        ...
        if (cellNoise < 0.25f || (cellY > WildChunkGenerator.SEA_LEVEL_Y - 10 && cellNoise < 0.5f))
        {
